    ...
    <div
        ...
        <div
            ...
            <div class="text-center">
                ...
                <h2 class="mt-4 text-3xl font-extrabold text-gray-900 tracking-tight">Welcome Back!</h2>
            ...
            <form class="mt-8 space-y-5" method="POST" action="{{ route('login') }}">
                ...
                @if (session('status'))
                    <div class="bg-green-50 border-l-4 border-green-400 text-green-700 px-4 py-3 rounded-lg shadow-sm">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="{{ route('password.request') }}"
                            class="font-medium text-orange-600 hover:text-orange-500 transition duration-150">
                            Forgot password?
                        </a>
                    </div>
                </div>
