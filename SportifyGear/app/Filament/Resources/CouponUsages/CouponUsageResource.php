...
class CouponUsageResource extends Resource
{
    ...
    protected static string | \UnitEnum | null $navigationGroup = 'Promotions & Discounts';

    protected static ?int $navigationSort = 2;

    protected static ?string $recordTitleAttribute = 'coupon_id';
    ...
    {
        return \App\Filament\Resources\Coupons\Tables\CouponUsagesTable::configure($table);
    }
